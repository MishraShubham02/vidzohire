        ...
        <Row className="pt-4">
          <Col md={4}>
            <div className="card1_why">
              ...
              <h6 className="pt-2">For job seekers, search on</h6>
              <p>
                For your ideal job click on find job and embark your journey of
          ...
          <Col md={4}>
            <div className="card1_why">
              ...
              <p>
                Dive deeper into our exhaustive search results and unveil a
